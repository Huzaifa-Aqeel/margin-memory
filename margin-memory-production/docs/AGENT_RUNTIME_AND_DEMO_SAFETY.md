...
Jobs created by the pre-021 demo route already carry demo origin and can be removed safely after migration 021 is applied. A sample estimate created by that older route predates estimate-origin tracking and therefore cannot be automatically identified safely; inspect that estimate manually rather than deleting it by name. New seeds do not have this ambiguity.
